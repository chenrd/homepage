...
> logback 是目前日志输出效率最高的组件，遵循slf4j，所以如果原来用的log4j-slf4j要改成用logback非常简单，替换依赖跟配置文件即可
...
<configuration>  
    ...
    <substitutionProperty name="logbase" value="${catalina.base}/logs/user_center/" />  
    <!--每个appender都是一个日志策略 -->  
